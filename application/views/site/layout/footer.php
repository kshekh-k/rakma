 ...
 <footer class="bg-gray-100">
     <div
         class="w-full max-w-screen-lg xl:max-w-screen-xl px-4 xl:px-12 mx-auto grid grid-cols-12 gap-x-4 gap-y-7 lg:gap-4 py-10 md:py-20">

         <div class="col-span-12 sm:col-span-6 lg:col-span-4 space-y-7">
             <h4 class="text-xl xl:text-2xl font-medium text-gray-900 ">Contact Us</h4>
             <div class="flex flex-col items-start w-full font-medium max-w-xs gap-4">
                 <address class=" inline-flex space-x-2 not-italic text-gray-500 items-start ">
                     ...
                     <span><?php echo get_settings('contact_us_address'); ?></span>
                 </address>

                 <a href="tel:<?php echo get_settings('contact_us_phone'); ?>"
                     class="text-gray-500 hover:text-secondary  hidden space-x-3"><svg viewBox="0 0 14.47 14.5"
                         fill="currentColor" class="w-3.5">
                         <path
                             ...
                             transform="translate(-1099.78 -61.75)"></path>
                     </svg>
                     <span><?php echo get_settings('contact_us_phone'); ?></span>
                 </a>



                 <a href="mailto:help@rakma.org" class="text-gray-500 hover:text-secondary inline-flex space-x-3"><svg
                         ...
                         <path
                             ...
                             transform="translate(-1239.19 -62.563)"></path>
                     </svg>
                     <span><?php echo get_settings('contact_us_email'); ?></span>
         ...
         <div class="col-span-12 sm:col-span-6 lg:col-span-8 space-y-7">
             <h4 class="text-xl xl:text-2xl font-medium text-gray-900 ">Quick Links</h4>
             <div class="grid grid-cols-2 gap-3 w-full font-medium">
                 <ul class="uppercase space-y-3 text-sm font-semibold">
                     <li><a href="<?php echo base_url(); ?>" class="text-gray-500 hover:text-secondary">Home</a></li>
                     <li><a href="<?php echo base_url('page/about') ?>" class="text-gray-500 hover:text-secondary">About
                             us</a></li>
                     <li><a href="<?php echo base_url('/page/executives'); ?>"
                             class="text-gray-500 hover:text-secondary">Executive</a></li>
                     <li><a href="<?php echo base_url('/welfare/welfarelist') ?>"
                             class="text-gray-500 hover:text-secondary">Social Welfare</a></li>
                     <li><a href="<?php echo base_url('/news/newslist') ?>"
                             class="text-gray-500 hover:text-secondary">News</a></li>
                     <li><a href="<?php echo base_url('/event/eventlist') ?>"
                             class="text-gray-500 hover:text-secondary">Events</a></li>
                     <li><a href="<?php echo base_url('/page/contact') ?>"
                             class="text-gray-500 hover:text-secondary">Contact us</a></li>
                     <li><a href="<?php echo base_url('page/gallery') ?>"
                             class="text-gray-500 hover:text-secondary">Gallery</a></li>
                 </ul>
                 <ul class="uppercase space-y-3 text-sm font-semibold">
                     ...
                     <li><a href="<?php echo base_url('/page/ourmember'); ?>"
                             class="text-gray-500 hover:text-secondary">Members List</a></li>
                     <li><a href="<?php echo base_url('/page/permanentmember'); ?>"
                             class="text-gray-500 hover:text-secondary">Permanent Members List</a></li>
                     <li><a href="<?php echo base_url('/page/pdflist'); ?>"
                     ...
                     <li><a href="<?php echo base_url('/page/termsconditions'); ?>"
                             class="text-gray-500 hover:text-secondary">Terms & Conditions</a></li>
                     <li><a href="<?php echo base_url('/page/refundpolicy'); ?>"
                             class="text-gray-500 hover:text-secondary">Refund & Cancellation Policy</a></li>
                     <li><a href="javascript:void(0)" class="text-gray-500 hover:text-secondary">Our Constitution</a>
                     </li>
                 </ul>
             </div>
         </div>

         <div class="col-span-12 lg:col-span-3 space-y-4 lg:space-y-7 max-w-sm hidden">
             <h4 class="text-xl xl:text-2xl font-medium text-gray-900 ">Join our Newsletter</h4>

             <p class="font-medium text-gray-500 line-clamp-2">Join Our newsletter to get our updates for events and
                 news</p>
             ...
             <div class=" mx-auto mt-10">
                 ...
                 <form action="">
                     <div class="relative w-full ">
                         <input type="text"
                             class="border border-gray-400 bg-gray-100 rounded py-3 pl-4 outline-none ring-0 focus:ring-0 focus:outline-none focus:border-secondary focus:placeholder-secondary focus:text-secondary w-full pr-12"
                             placeholder="Enter your email">
                         <button
                             class="absolute top-0 right-0 rounded-r w-12 items-center justify-center flex inset-y-0 bg-primary text-white cursor-pointer  focus:outline-none hover:bg-secondary">

                             <svg class="w-5" viewBox="0 0 21 21" fill="currentColor">
                                 <path
                                     d="M1370.95,4501.86l-2.44,14.38a3.3,3.3,0,0,1-5.09,2.2l-4.4-2.93a0.818,0.818,0,1,1,.91-1.36l4.4,2.93a1.675,1.675,0,0,0,2.57-1.11l2.44-14.39a1.669,1.669,0,0,0-2.33-1.79l-14.39,6.43a1.647,1.647,0,0,0-.98,1.38,1.629,1.629,0,0,0,.74,1.52l2.01,1.34a0.822,0.822,0,0,1-.91,1.37l-2.01-1.34a3.314,3.314,0,0,1,.48-5.77l14.39-6.43A3.3,3.3,0,0,1,1370.95,4501.86Zm-6.43,1.75a0.817,0.817,0,1,1,1.15,1.16l-7.71,7.64a2.785,2.785,0,0,0-.83,1.98v3.79a0.82,0.82,0,1,1-1.64,0v-3.79a4.453,4.453,0,0,1,1.31-3.14Z"
                                     transform="translate(-1350 -4498)" />
                             </svg> </button>
                     </div>
     ...
     <div class="bg-primary">
         <div class="max-w-screen-lg xl:max-w-screen-xl px-4 xl:px-12 mx-auto flex items-center">
             <p class="text-sm font-normal text-white ml-0 mr-auto">Copyright &copy; <?php echo date('Y'); ?> RAKMA.</p>
             <div class="overflow-hidden w-64 relative wellfundf border-r-4 border-white ml-auto mr-0">
                 <a href="<?php echo base_url('/page/welfarefund'); ?>"
                     class="absolute z-10 uppercase inset-0 flex justify-center items-center font-bold text-white tracking-wider"><span
                         class="pl-2 inline-flex text-sm sm:text-base">Welfare Fund</span></a>
                 <span
                     class="wellfundf-bg transform -skew-x-12 bg-secondary relative ml-auto -mr-3 block border-l-4 border-white w-full h-14"></span>
             </div>
         </div>
     </div>
 </footer>
 ...
 <script src="<?php echo base_url('assets/site'); ?>/src/dist/js/alpine.js"></script>
 <script src="<?php echo base_url('assets/site'); ?>/src/dist/js/cropbox-min.js"></script>

...
<form id="register__form" action="<?php echo base_url('/registers/save'); ?>" method="post" enctype='multipart/form-data'>
    <h1>Testing</h1>
    <!-- General Information -->
      ...
      <div class="upload-file">
        ...
        <div class="pt-7">
            ...
            <div class="grid sm:grid-cols-8 lg:grid-cols-12 gap-5 lg:gap-10 pt-3 xs:pt-7">
                ...
                <div class="relative sm:col-span-4 text-left">
                    <label for="" class="text-gray-600 font-semibold pb-1 px-2 block">Date of Birth<em class="text-secondary">*</em>
                    </label>
  ...
  var membership_id = $('input[name="membership_plan"]:checked').data('id');
    ...
    var options = {
        ...
        "handler": function(response) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo base_url('/registers/updatesucesspaymentstatus') ?>',
                data: {
                    userdata: userdata,

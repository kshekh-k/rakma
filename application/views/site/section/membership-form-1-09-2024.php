...
<div class="rounded bg-white relative">
    ...
    <div class="bg-gray-100 p-3 xs:p-8 lg:p-10 lg:pt-16 pt-5">
        ...
        <div class="py-8 lg:py-20 max-w-4xl mx-auto">
            ...
            if ($date_now > '2024-12-20') { ?>
                <button type="button" onclick=" alert('Membership is closed on 20-12-2021 after 12 PM');" class="rounded flex justify-center items-center font-medium text-white tracking-wider uppercase bg-primary hover:bg-secondary shadow-md py-4 w-56">Submit</button>
         <?php }else { ?>

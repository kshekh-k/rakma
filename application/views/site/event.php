 <main class="">
         ...
         <section class="relative">
            ...
            <div class="z-10 absolute inset-0 py-10 md:py-20 flex items-center">
               <div class="max-w-screen-xl w-full px-4 xl:px-12 mx-auto flex flex-col items-center text-center">
                <h1 class="text-2xl sm:text-4xl xl:text-5xl uppercase text-secondary font-bold tracking-wide">Events</h1>
                ...
                <!-- Breadcrumb -->
                <p class="flex gap-2 pt-2 font-medium text-gray-500"><a href="<?php echo base_url(); ?>" class="hover:text-secondary">Home</a>/<span class="text-blues">Events</span></p>
               </div>
            </div>
         </section>
         ...
         <section class="relative py-5 xl:py-16"> 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap5 lg:gap-10 w-full">
               ...
               <?php if ($event_list) {  foreach ($event_list as $key => $event) { //print_r($event); ?>
                  ...
                  <div class="bg-gray-100 p-4 sm:p-7 flex flex-col relative">
                     ...
                     <img src="<?php echo base_url('uploads/'.$event['image']) ?>" alt="" class="object-cover">
                     </div>
                     <div class="pt-5">
                     <h3 class="text-2xl text-gray-900 font-medium text-left truncate"><?php echo $event['title']; ?></h3>
                     <!-- date -->
                     ...
                     </svg> <span><?php echo date("d M Y", strtotime($event['create_at'])); ?></span></span> <span class="flex gap-1"><svg class="w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                     </svg><span><?php echo $event['location']; ?></span></span></p>

                     <!-- Description -->
                     <p class="text-gray-600 text-left line-clamp-4 font-medium leading-loose my-3"> <?php echo mb_strimwidth($event['description'], 0, 160, "..."); ?></p>    
                  ...
                  <!-- Post Detail Link -->
                  <a href="<?php echo base_url('event/'.$event['id']) ?>" class="absolute inset-0 opacity-0"><span class="hidden">Hidden Link</span></a>

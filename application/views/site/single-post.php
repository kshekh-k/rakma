...
<div class="pt-5">
    <div class="overflow-hidden flex items-center justify-center bg-white float-left md:mr-4 mb-2">        
...
<div class="text-gray-600 font-medium leading-loose text-justify" id="content">
   ...
   <div class="lg:col-span-4 md:col-span-5 md:border-l border-gray-200 pl-5 lg:pl-10">
            ...
            <div class="bg-gray-100 p-8">
             <h3 class="text-xl text-gray-900 font-medium text-left">Recent Welfare Post</h3>

            ...
            <div class="z-10 absolute inset-0 py-10 md:py-20 flex items-center">
                <div class="max-w-screen-xl w-full px-4 xl:px-12 mx-auto flex flex-col items-center text-center">
                    <h1 class="text-2xl sm:text-4xl xl:text-5xl uppercase text-secondary font-bold tracking-wide">
                        Membership</h1>
                    <p class="text-primary font-medium pt-2 capitalize"><span class="uppercase">RAKMA</span> (Raj.
                        Adhikari Karmachari Minority Association)</p>
                    <!-- Breadcrumb -->
                    <p class="flex gap-2 pt-2 font-medium text-gray-500"><a href="javascript:void(0)"
                            class="hover:text-secondary">Home</a>/<span class="text-blues">Membership</span></p>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-screen-xl px-4 xl:px-12 mx-auto flex flex-col items-center text-center">
                <div class="xl:shadow-4 w-full xl:p-5 ring-1 ring-gray-300 xl:ring-0">
                    ...
                    <div class="bg-gray-100 p-3 xs:p-8 lg:px-10 ">
                        ...
                        <form action="<?php echo base_url('/register/checkref') ?>" method="post" id="refr__form">
                            <!-- This is main form -->
                            <!-- <form method="post" id="refr__form"> -->
                            <div class="grid sm:grid-cols-2 gap-5 pt-3 xs:pt-7 max-w-xl mx-auto">
                                <div class="relative text-left">
                                    <label for="" class="text-gray-600 font-semibold pb-1 px-2 block">Mobile No.<em
                                            class="text-secondary">*</em></label>
                                    <input type="text" placeholder="Enter Ref. Mobile No." id="ref_mobile"
                                        name="ref_mobile"
                                        class="check__number_format ring-0 border border-gray-300 rounded p-2 md:p-3 focus:outline-none outline-none focus:border-primary focus:placeholder-primary focus:text-primary w-full focus:ring-0">
                                </div>
                        ...
                        <!-- Existing Member -->
                        <p class="py-3 border-t border-gray-200 mt-3 text-gray-600 font-medium  text-sm sm:text-base">
                            Are you existing member and want upgrade your membership. <a
                                href="<?php echo base_url('/page/membershipupgrade') ?>"
                                class="text-blue-600 hover:text-secondary undeline block xs:inline-block">Upgrade
                                Now</a></p>
                        <div id="ref_alert"></div>
                    </div>

                    <!-- Message to member page -->
                    <!-- 
                    when want to close memebership show this message
                    <div class="bg-gray-100 p-3 xs:p-8 lg:px-10">
                        <h3 class="text-blues text-xl xs:text-2xl font-semibold uppercase">The membership registration
                            has been closed.</h3>
                        <h3 class="text-blues text-xl xs:text-2xl font-semibold uppercase pt-2">सदस्यता अभियान बंद हो
                            चुका है।</h3>
                    </div>
                    -->

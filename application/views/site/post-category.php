 ...
 <main class="">
         ...
         <section class="relative">
            ...
            <div class="z-10 absolute inset-0 py-10 md:py-20 flex items-center">
               <div class="max-w-screen-xl w-full px-4 xl:px-12 mx-auto flex flex-col items-center text-center">
                <h1 class="text-2xl sm:text-4xl xl:text-5xl uppercase text-secondary font-bold tracking-wide"><?php echo $cat_data['cat_name']; ?></h1>
                ...
                <!-- Breadcrumb -->
                <p class="flex gap-2 pt-2 font-medium text-gray-500"><a href="<?php echo base_url(); ?>" class="hover:text-secondary">Home</a>/<span class="text-blues"><?php echo $cat_data['cat_name']; ?></span></p>
               </div>
            </div>
         </section>
         ...
         <section class="relative py-5 xl:py-16"> 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap5 lg:gap-10 w-full">
               ...
               <?php if ($post_list) {  foreach ($post_list as $key => $news) { ?>
                  ...
                  <div class="bg-gray-100 p-4 sm:p-7 flex flex-col relative">
                     ...
                     <!-- Description -->
                     <p class="text-gray-600 text-left line-clamp-4 font-medium leading-loose my-3"> <?php echo mb_strimwidth($news['description'], 0, 160, "..."); ?></p>    
                  ...
                  <!-- Post Detail Link -->
                  <a href="javascript:void(0)" class="absolute inset-0 opacity-0"><span class="hidden">Hidden Link</span></a>

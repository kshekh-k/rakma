...
<head>
    ...
    <link href="<?php echo base_url('assets/admin/') ?>dist/css/custom2.css" rel="stylesheet">
...
<![endif]-->
	...
	<script src="https://kit.fontawesome.com/e13e70fac4.js" crossorigin="anonymous" defer></script>
                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <img src="<?php echo base_url('/uploads/') ?><?php echo get_settings('logo'); ?>" alt="homepage" class="light-logo"  width="50px"/>
                           
                        </b>
                        <!--End Logo icon -->
                         <!-- Logo text -->
                        <span class="logo-text text-white font-weight-bold pl-4">
                             <!-- dark Logo text -->
RAKMA

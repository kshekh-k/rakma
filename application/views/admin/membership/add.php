<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="<?php echo base_url('/admin/membership/save'); ?>" method="post" enctype='multipart/form-data'>
                                <div class="card-body">
                                       <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                     ...
                                     <div class="form-group row">
                                       ...
                                       <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea name="description" id="editor" class="form-control" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control" name="gallery">
                                                ...
                                                <?php if($gallery_list){ foreach ($gallery_list as $key => $gallery) { ?>
                                                    ...
                                                    <option value="<?php echo  $gallery['id'] ?>">#<?php echo  $gallery['id'] ?> --- <?php echo  $gallery['title'] ?></option>

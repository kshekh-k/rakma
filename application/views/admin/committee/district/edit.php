<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                               <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Committee Member</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="<?php echo base_url('/admin/committee/updatedistrictcommitteemember/'.$row['id']); ?>" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="card-body">
                                     ...
                                     <a href="<?php echo base_url('/admin/committee/districtcommitteememberlist/'.$row['c_id']) ?>" class="btn btn-info btn-sm float-right mb-4"><i class="fa fa-angle-left" aria-hidden="true"></i>  Back</a>
                                        </div>
                                    </div>

<div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="<?php echo base_url('/admin/committee/update/'.$row['id']); ?>" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="card-body">
                                     ...
                                     <a href="<?php echo base_url('/admin/committee/othercommitteememberlist/'.$row['c_id']) ?>" class="btn btn-info btn-sm float-right mb-4"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a>
                                        </div>
                                    </div>

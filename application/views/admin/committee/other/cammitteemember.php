                            ...
                            <div class="card-body">
                               ...
                               <?php } ?>
                                ...
                                <h5 class="card-title float-left"><?php echo $section_heading; ?></h5>
                                 <?php if ($row) { ?>
                                 <a href="<?php echo base_url('/admin/committee/add/'.$row['id']) ?>" class="btn btn-success btn-sm float-right mb-4"><i class="fa fa-plus"></i> Add member</a> 
                                <a href="<?php echo base_url('/admin/committee/export/'.$row['id']) ?>" class="mr-2 btn btn-primary btn-sm float-right mb-4"><i class="mdi mdi-download"></i> Downlaod CSV</a>
                                 ...
                                 <a href="<?php echo base_url('/admin/committee/othercommitte') ?>" class="btn btn-info btn-sm float-right mb-4 mr-2"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a> 
                                 <?php } ?>
                                        ...
                                        <tbody  id="drag__row">
                                            ...
                                            <tr  data-id="<?php echo $value['id']; ?>" >
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url('admin/committee/edit/'.$value['id']) ?>" class="btn btn-success btn-sm mb-2" title="Edit" ><i class="fa fa-pencil" aria-hidden="true"></i></a>

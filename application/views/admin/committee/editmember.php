<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                               <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('admin/news') ?>">Mahasamiti</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Edit Mahasamiti Member</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="<?php echo base_url('/admin/committee/updatemember/'.$row['id']); ?>" method="post" enctype='multipart/form-data'>
                                ...
                                <div class="card-body">
                                     ...
                                     <a href="<?php echo base_url('/admin/committee') ?>" class="btn btn-info btn-sm float-right mb-4"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a>
                                        </div>
                                    </div>
                                           ...
                                           <select class="form-control select2" name="member">
                                                ...
                                                <?php  if($members) {
                                                        ...
                                                        foreach ($members as $key => $member) { ?>
                                                            ...
                                                            <option value="<?php echo $member['id'] ?>" <?php if($member['id'] == $row['user_id']) {echo 'selected'; } ?>  ><?php echo $member['first_name'] ?> <?php echo $member['middle_name'] ?>  <?php echo $member['last_name'] ?> &nbsp;&nbsp;&nbsp;    <?php echo $member['father_husband_name'] ?> &nbsp;&nbsp;&nbsp;<?php echo $member['phone'] ?></option>

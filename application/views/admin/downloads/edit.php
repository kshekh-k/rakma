<div class="page-wrapper">
                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                               <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Download</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <form class="form-horizontal" action="<?php echo base_url('/admin/download/update/'.$row['id']); ?>" method="post" enctype='multipart/form-data'>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="fname" placeholder="Title" name="date" value="<?php echo $row['date']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row URL__section">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="fname" placeholder="URL" name="url" value="<?php echo $row['url']; ?>">
                                        </div>
                                    </div>

...
class Department extends CI_Controller {
	...
	{
		$data = array();
		$data['section_heading'] = 'All Department List';
		$data['rows'] = $this->common->getAllRecords('department' , 'DESC');
	...
	{
		$data = array();
		$data['section_heading'] = 'Add Department';
		$this->load->view('admin/layout/header');
		$this->load->view('admin/layout/sidebar');
	...
	public function save()
	{
			 ...
			 if ($this->form_validation->run() == true)
                {
                	...
                	$insert_id = $this->common->insert('department' , $insert);
		...
		redirect(base_url('admin/department/add'));
	}
...
public function edit($id='')
	{
		$data = array();
		$data['section_heading'] = 'Edit Department';
		$data['row'] = $this->common->getSingleRecordByFieldName(array('id'=> $id)  , 'department');
		$this->load->view('admin/layout/header');
		$this->load->view('admin/layout/sidebar');
	...
	public function update($id = '')
	{
			 ...
			 if ($this->form_validation->run() == true)
                {
                	...
                	$update = $this->common->update($id , $update ,  'department');
		...
		redirect(base_url('admin/department/edit/'.$id));
	}
	...
	public function delete($id= '')
	{
		...
		$data['row'] = $this->common->getAllRecordsByFieldName(array('id'=> $id )  , 'department');


		$delete = $this->common->deleteRecordByColumnName(array('id'=> $id)  , 'department');
	...
	public function status($id= '')
	{
		...
		$checkstatus = $this->common->getSingleRecordByFieldName(array('id'=> $id)  , 'department');

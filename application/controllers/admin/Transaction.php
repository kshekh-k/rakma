...
class Transaction extends CI_Controller {
	...
	{
		$data = array();
		$data['section_heading'] = 'All Transaction List';
		$data['rows'] = $this->common->transaction();
	...
	public function paymentst($id= '')
		{
			$get_data = $this->common->getSingleRecordByFieldName(array('id'=> $id)  , 'transaction');
			...
			if ($get_data) {
				...
				$this->common->update($id , $update , 'transaction');

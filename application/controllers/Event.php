...
class Event extends CI_Controller {
	...
	public function index($id="")
	{
		...
		$result  = $this->common->getSingleRecordByFieldName(array('status' => '1' , 'id'=>$id ) , 'events');
		$data['latest_post'] = $this->common->getAllRecordsByFieldName(array('status' => '1' , 'id !='=>$id ) , 'events' , 'DESC' , '5');
		...
		$this->load->view('site/single-event' , $data);
	...
	public function eventlist()
	{
		...
		$data['title'] = 'Event list';
				...
				$total_rows = $this->common->countrecords(array('status' => '1' ) , 'events');
             ...
             <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd" />
				...
				$data['event_list'] = $this->common->getAllRecordsByFieldName(array('status' => '1' ) , 'events' , 'DESC' , $per_page , $page);
